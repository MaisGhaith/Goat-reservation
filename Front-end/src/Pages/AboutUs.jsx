...
<style>
    @import url('https://fonts.googleapis.com/css2?family=Roboto+Slab&display=swap%27);
</style>
                    ...
                    <div className="flex flex-wrap ">
                        ...
                        <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0" >
                            ...
                            <p className="mt-6 mb-10 text-base leading-7 text-gray-500 dark:text-gray-400">
                                "Empowering athletes and sports enthusiasts by providing a comprehensive platform that offers easy access to a wide range of high-quality pitches, fostering a vibrant community where individuals can discover, book, and enjoy their favorite sports activities with convenience and confidence."
            ...
            <div>
                ...
                <div >
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4  '>
                        {about.map((about) => (
                            <div className=" px-10 pt-10" key={about.id}>
                                <div className=" ">
